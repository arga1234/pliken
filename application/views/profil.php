      ...
      <nav id="menu" class="navbar">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
			...
			<!-- Static Header -->
      <div style="margin-top:300px" class="header-text-3 wow fadeInUp" data-wow-delay=".2s" data-wow-duration="2s">
          <h1 >Profil Desa</h1>
          <p>Kenalilah Kekayaan Desa Pliken</p>
           </div>
         </div>
       </header>
	<!-- /Section: intro -->
...
<section id="page-content" class="index-page">
      ...
      <div style="margin-top:100px"class="col-md-12 ">
        <div  class="col-md-6 ">
          <img style="width:80%"src="<?php echo base_url()?>assets/images/profil1.jpg">
        </div>
        <div class="col-md-6 ">
          <div class="header-text-4">
            <h1> Wilayah di Beber </h1>
            <p> Desa Pliken terbagi atas 5 dusun dan 2 wilayah besar yang terkenal, yakni Grumbul dan Jurig. Di Grumbul Anda dapat menemukan arel persawahan dan tanah lapang, cocok dijadikan tempat untuk bersantai atau bermain.</p>
          </div>
        </div>
      </div>
      <!--panel kedua-->
