...
<div class="col-md-10">
  ...
  <p class="paragraf">
  &emsp; &ensp;  Berdasarkan Surat Keterangan dari Ketua Rukun Tetangga Nomor  <?php echo $row['ns_rtdanrw']?> Tanggal <?php echo $row['tgl_surat']?>, bahwa yang bersangkutan betul warga Desa Pliken dan menurut pengakuan yang bersangkutan keadaan ekonominya TIDAK MAMPU.
  </p>
  ...
  <p style="margin-left:500px;margin-bottom:95px" class="paragraf">
