...
$query="UPDATE warga SET alamat='$alamat', ns_rtdanrw='$ns_rtdanrw', tgl_surat='$tgl_surat', nm_perusahaan='$nm_perusahaan', pemilik='$pemilik', alm_perusahaan='$alm_perusahaan', j_usaha='$j_usaha', sts_usaha='$sts_usaha', jml_kar='$jml_kar', waktu='$waktu', luas='$luas', pengesah_1='$pengesah_1', pengesah_2='$pengesah_2', nmpengesah_1='$nmpengesah_1', nmpengesah_2='$nmpengesah_2', agama='$agama',rt='$rt',rw='$rw',  pekerjaan='$pekerjaan',  tgl_masuk='$tgl_masuk' WHERE nik='$nik'";
                          ...
                          <div class="col-lg-12">
                            <div class="panel panel-color panel-purple">
                              ...
                              <div class="panel-body">
                                ...
                                ?>
                                <a style="margin-top:10px"class="btn btn-purple waves-effect waves-light" href="<?php echo base_url()?>index.php/admin/print_skdu?nik=<?php echo $row['nik'] ?>">Print</a>
                              </div>
                            </div>
                          </div>
