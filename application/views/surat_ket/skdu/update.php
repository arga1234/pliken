                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Surat Keterangan Domisili Usaha </p>
                            </div>
                        </div>
                        <div class="row">
                                                      ...
                                                      <div class="panel panel-color panel-purple">
                                                        ...
                                                        <div class="panel-body">
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_skdu_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                              ...
                                                              <div   class="form-group col-md-4">
                                                                <label >RT</label>
                                                                <input type="text"  name="rt" value="<?php echo $row['rt'] ?>" class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                <label >RW</label>
                                                                <input type="text" name="rw"  value="<?php echo $row['rw']?>" class="form-control">
                                                              </div>
                                                              ...
                                                              <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" name="pekerjaan"  value="<?php echo $row['pekerjaan']?>" class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-4">
                                                                  <label> No Surat RT/RW</label>
                                                                    <input name="ns_rtdanrw"type="text" required class="form-control" >
                                                              </div>

                                                              <div  style="margin-left:10px" class="form-group col-md-4">
                                                                  <label> Tgl Surat RT/RW</label>
                                                                    <input name="tgl_surat"type="text" required class="form-control" >
                                                              </div>

                                                              <div  style="margin-left:10px" class="form-group col-md-4">
                                                                  <label> Tgl permohonan</label>
                                                                    <input name="tgl_masuk"type="text" required class="form-control" >
                                                              </div>

                                                              <div  class="form-group col-md-4">
                                                                <label >Nama Perusahaan</label>
                                                                <input type="text" name="nm_perusahaan"  required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                <label >Nama Pemilik</label>
                                                                <input type="text" name="pemilik"  required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                <label >Alamat Perusahaan</label>
                                                                <input type="text" name="alm_perusahaan"  required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-4">
                                                                <label >Jenis Usaha</label>
                                                                <input type="text" name="j_usaha"  required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                <label >Status Perusahaan</label>
                                                                <input type="text" name="sts_usaha"  required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                <label >Jumlah Karyawan</label>
                                                                <input type="text" name="jml_kar"  required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-6">
                                                                <label >Luas Tempat Usaha</label>
                                                                <input type="text" name="luas"  required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-6">
                                                                <label >Waktu usaha</label>
                                                                <input type="text" name="waktu"  required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-6">
                                                                  <label>Pengesah 1</label>
                                                                    <input name="pengesah_1"type="text" required class="form-control">
                                                              </div>

                                                              <div  style="margin-left:10px" class="form-group col-md-6">
                                                                  <label >Nama Pengesah 1</label>
                                                                    <input name="nmpengesah_1"type="text" required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-6">
                                                                  <label>Pengesah 2</label>
                                                                    <input name="pengesah_2"type="text" required class="form-control">
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-6">
                                                                  <label>Nama Pengesah 2</label>
                                                                    <input name="nmpengesah_2"type="text" required class="form-control">
                                                              </div>
