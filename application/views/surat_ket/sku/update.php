                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Surat Keterangan Umum</p>
                            </div>
                        </div>
                        <div class="row">
                                                          ...
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_skU_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                              ...
                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                ...
                                                                <input type="text" name="pendidikan"  value="<?php echo $row['pekerjaan']?>" class="form-control">
                                                              </div>
