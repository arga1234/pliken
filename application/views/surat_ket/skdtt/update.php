                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Surat Keterangan Domisili Tempat Tinggal </p>
                            </div>
                        </div>
                        <div class="row">
                                                      ...
                                                      <div class="panel panel-color panel-purple">
                                                        ...
                                                        <div class="panel-body">
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_skdtt_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                          ...
                                                          <div style="margin-left:10px" class="form-group col-md-3">
                                                              <label>Bin/Binti</label>
                                                                <input name="bin_binti"type="text" required class="form-control" >
                                                          </div>
                                                          ...
                                                          <div  class="form-group col-md-6">
                                                              <label>Pengesah</label>
                                                                <input name="pengesah_2"type="text" required class="form-control"  value="<?php echo $row['pengesah_2']?>">
                                                          </div>
