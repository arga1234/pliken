...
<div class="col-md-10">
  ...
  <p class="paragraf">
    &ensp; Bin/Binti &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;: <?php echo $row['bin_binti']?>
  </p>
  ...
  <p class="paragraf">
    &ensp; Warganegara/Agama &nbsp;&nbsp;: WNI / <?php echo $row['agama']?>
  </p>
  <p class="paragraf">
  ...
  <p class="paragraf">
  &emsp; &ensp;  Berdasarkan Surat Keterangan dari Ketua Rukun Warga nomor <?php echo $row['ns_rtdanrw']?> tanggal&nbsp; <?php echo $row['tgl_surat']?>, bahwa yang bersangkutan benar penduduk Desa Pliken Kecamatan Kembaran Kabupaten Banyumas yang beralamat pada alamat tersebut di atas, surat ini dibuat untuk keperluan &nbsp;<?php echo $row['keperluan']?>.
  </p>


  <p style="margin-bottom:250px" class="paragraf">
    &emsp; &ensp; Demikian Surat Keterangan ini kami buat atas permintaan yang bersangkutan agar yang berkepentingan mengetahui dan maklum.
  </p>


  <p style="margin-left:500px;margin-top:-185px;margin-bottom:95px" class="paragraf">
