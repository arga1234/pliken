...
$query="UPDATE warga SET tgl_surat='$tgl_surat', ns_rtdanrw='$ns_rtdanrw', bin_binti='$bin_binti', alamat='$alamat', keperluan='$keperluan', pengesah_2='$pengesah_2', nmpengesah_2='$nmpengesah_2', agama='$agama',rt='$rt',rw='$rw', pekerjaan='$pekerjaan',  tgl_masuk='$tgl_masuk' WHERE nik='$nik'";
                          ...
                          <div class="col-lg-12">
                            <div class="panel panel-color panel-purple">
                              ...
                              <div class="panel-body">
                                ...
                                ?>
                                <a style="margin-top:10px"class="btn btn-purple waves-effect waves-light" href="<?php echo base_url()?>index.php/admin/print_skdtt?nik=<?php echo $row['nik'] ?>">Print</a>
                              </div>
                            </div>
                          </div>
