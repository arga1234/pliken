...
$query="UPDATE warga SET  data1='$data1',data2='$data2',data3='$data3',data4='$data4',data5='$data5', data6='$data6', alamat='$alamat', pengesah_1='$pengesah_1', nmpengesah_1='$nmpengesah_1', agama='$agama',hubungan='$hubungan',status='$status',rt='$rt',rw='$rw', pendidikan='$pendidikan', pekerjaan='$pekerjaan' WHERE nik='$nik'";
                          ...
                          <div class="col-lg-12">
                            <div class="panel panel-color panel-purple">
                              ...
                              <div class="panel-body">
                                ...
                                ?>
                                <a style="margin-top:10px"class="btn btn-purple waves-effect waves-light" href="<?php echo base_url()?>index.php/admin/print_spu_pernyataan?nik=<?php echo $row['nik'] ?>">Print</a>
                              </div>
                            </div>
                          </div>
