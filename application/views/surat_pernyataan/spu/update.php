                                                      ...
                                                      <div class="panel panel-color panel-purple">
                                                        ...
                                                        <div class="panel-body">
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_spu_pernyataan_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                              ...
                                                              <div style="margin-left:10px" class="form-group col-md-10">
                                                                  <label>Surat Pernyataan</label>
                                                                    <input name="data1" type="text" required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-12">
                                                                  <label> Menyatakan Bahwa</label>
                                                                    <input name="data2"type="text" required class="form-control" >
                                                              </div>

                                                              <div class="form-group col-md-6">
                                                                  <label>Saksi 1</label>
                                                                    <input name="data3"type="text" required class="form-control" >
                                                              </div>

                                                              <div style="margin-left:10px" class="form-group col-md-6">
                                                                  <label >Saksi 2</label>
                                                                    <input name="data4"type="text" required class="form-control" >
                                                              </div>

                                                              <div class="form-group col-md-6">
                                                                  <label>Nama Ketua RT</label>
                                                                    <input name="data5"type="text" required class="form-control">
                                                              </div>

                                                              <div  style="margin-left:10px" class="form-group col-md-6">
                                                                  <label >Nama Ketua RW</label>
                                                                    <input name="data6"type="text" required class="form-control">
                                                              </div>
