                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Surat Pengantar Catatan Kepolisian </p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="panel panel-color panel-purple">
                              ...
                              <div class="panel-body">
                                <div class="col-md-12">
                                  ...
                                  <form method="post" action="<?php echo base_url()?>index.php/admin/update_skck_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                    ...
                                    <div style="margin-left:10px" class="form-group col-md-8">
