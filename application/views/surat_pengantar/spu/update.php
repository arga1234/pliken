                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Surat Pengantar Umum</p>
                            </div>
                        </div>
                        <div class="row">
                                                      ...
                                                      <div class="panel panel-color panel-purple">
                                                        ...
                                                        <div class="panel-body">
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_spu_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                              ...
                                                              <div style="margin-left:10px" class="form-group col-md-4">
                                                                ...
                                                                <input type="text" name="pendidikan"  value="<?php echo $row['pendidikan']?>" class="form-control">
                                                              </div>
                                                              ...
                                                              <div style="margin-left:10px" class="form-group col-md-10">
                                                                  <label>Keperluan</label>
                                                                    <input name="keperluan" type="text" required class="form-control">
                                                              </div>

                                                              <div class="form-group col-md-12">
                                                                  <label style="text-align: left;"class="col-md-2 control-label">Keterangan Lain</label>
                                                                    <input name="keterangan"type="text" required class="form-control">
                                                              </div>
                                                              ...
                                                              <div style="margin-left:10px" class="form-group col-md-6">
                                                                  <label >Berlaku s/d</label>
                                                                    <input name="berlaku"type="text" required class="form-control" >
                                                              </div>
