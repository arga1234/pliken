...
$query="UPDATE warga SET  alamat='$alamat', pengesah_1='$pengesah_1', pengesah_2='$pengesah_2', nmpengesah_1='$nmpengesah_1', nmpengesah_2='$nmpengesah_2', agama='$agama',hubungan='$hubungan',status='$status',rt='$rt',rw='$rw', pendidikan='$pendidikan', pekerjaan='$pekerjaan', keperluan='$keperluan', keterangan='$keterangan', tgl_masuk='$tgl_masuk', berlaku='$berlaku' WHERE nik='$nik'";
                          ...
                          <div class="col-lg-12">
                            <div class="panel panel-color panel-purple">
                              ...
                              <div class="panel-body">
                                ...
                                ?>
                                <a style="margin-top:10px"class="btn btn-purple waves-effect waves-light" href="<?php echo base_url()?>index.php/admin/print_spu?nik=<?php echo $row['nik'] ?>">Print</a>
                              </div>
                            </div>
                          </div>
