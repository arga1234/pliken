...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url()?>assets/fonts/fontawesome-webfont.eot?#iefix&v=4.6.3" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url()?>assets/fonts/fontawesome-webfont.eot?v=4.6.3" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url()?>assets/css/icons1.css" rel="stylesheet" type="text/css" />
    ...
    <div class="row">
      <div class="col-md-4 utama-1 ">
        <div class="box-item  wow fadeInLeft" data-wow-delay=".2s" data-wow-duration="2s" >
            <p class="utama-1-i"><i style="font-size:30px"class="fa fa-envira"></i></p>
      ...
      <div class="col-md-4 utama-2 ">
        <div class="box-item  wow fadeInLeft" data-wow-delay=".2s" data-wow-duration="2s" >
          <p class="utama-2-i"><i style="font-size:30px"class="fa fa-pagelines"></i></p>
      ...
      <div class="col-md-4 utama-3 ">
        <div class="box-item  wow fadeInLeft" data-wow-delay=".2s" data-wow-duration="2s">
          <p class="utama-3-i"><i style="font-size:30px"class="fa fa-camera-retro"></i></p>
...
<div class="row">
  <div style="margin-bottom:100px"class="col-md-12 header-text-2 wow fadeInDown" data-wow-delay=".2s" data-wow-duration="2s">
    ...
    <div style="margin-top:20px;margin-bottom:-20px"class="col-md-12">
      <a href="<?php echo base_url()?>index.php/ bh/pliken"class="btn btn-reguler">
                        <i class="fa fa-rocket"></i> More
                      </a>
