...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    ...
    <link href="<?php echo base_url()?>assets/cssalbum/stylealbumtaman.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="wrap-body">
    ...
    <div class="w3_agile_logo">
    	<h1 class="text-center"><a href="index.html">Taman</a></h1>
    </div>
    <!-- banner -->
    <div class="w3_banner">
    	<div class="container">
