...
$query="UPDATE warga SET pengesah_1='$pengesah_1', pengesah_2='$pengesah_2', nmpengesah_1='$nmpengesah_1', nmpengesah_2='$nmpengesah_2', agama='$agama',hubungan='$hubungan',status='$status',rt='$rt',rw='$rw', pendidikan='$pendidikan', pekerjaan='$pekerjaan', keperluan='$keperluan', keterangan='$keterangan', tgl_masuk='$tgl_masuk', berlaku='$berlaku' WHERE nik='$nik'";
