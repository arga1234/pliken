                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Silahkan cek kebenaran dari data orang yang berasangkutan pada kotak update data</p>
                            </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="panel panel-color panel-purple">
                              <div class="panel-heading">
                                <h3 class="panel-title">Data Tetap</h3>
                              </div>
                              <div class="panel-body">
                                <div class="col-md-12">
                                  <form class="form-horizontal" role="form">
                                <div class="form-group">
                                    <label style="text-align: left;"class="col-md-2 control-label">NKK</label>
                                    <label style="text-align: left;"class="col-md-1 control-label">:</label>
                                    <div class="col-md-6">
                                      <p style="margin-top:5px"><?php echo $row['nkk']?></p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label style="text-align: left;"class="col-md-2 control-label">NIK</label>
                                    <label style="text-align: left;"class="col-md-1 control-label">:</label>

                                    <div class="col-md-6">
                                      <p style="margin-top:5px"><?php echo $row['nik']?></p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label style="text-align: left;"class="col-md-2 control-label">Nama</label>
                                    <label style="text-align: left;"class="col-md-1 control-label">:</label>

                                    <div class="col-md-6">
                                      <p style="margin-top:5px"><?php echo $row['nama']?></p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label style="text-align: left;"class="col-md-2 control-label">Kelamin</label>
                                    <label style="text-align: left;"class="col-md-1 control-label">:</label>

                                    <div class="col-md-6">
                                      <p style="margin-top:5px"><?php echo $row['kelamin']?></p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label style="text-align: left;"class="col-md-2 control-label">TTL</label>
                                    <label style="text-align: left;"class="col-md-1 control-label">:</label>

                                    <div class="col-md-6">
                                      <p style="margin-top:5px"><?php echo $row['tmp_lahir'] ?>,<?php echo $row['tgl_lahir'] ?></p>
                                    </div>
                                </div>
                                                      ...
                                                      <div class="panel panel-color panel-purple">
                                                        ...
                                                        <div class="panel-body">
                                                          <div class="col-md-12">
                                                            ...
                                                            <form method="post" action="<?php echo base_url()?>index.php/admin/update_sku_sukses?nik=<?php echo $row['nik'] ?>" class="form-horizontal" role="form">
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Agama</label>
                                                              <div class="col-md-10">
                                                          ...
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Hubungan</label>
                                                              <div class="col-md-10">
                                                                <input type="text" name="hubungan" class="form-control" value="<?php echo $row['hubungan']?>">
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">RT</label>
                                                              <div class="col-md-10">
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <label style="text-align: left;"class="col-md-2 control-label">RW</label>
                                                              <div class="col-md-10">
                                                          ...
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Pendidikan</label>
                                                              <div class="col-md-10">
                                                                <input name="pendidikan"type="text" class="form-control" value="<?php echo $row['pendidikan']?>">
                                                              </div>
                                                          </div>

                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Pekerjaan</label>
                                                              <div class="col-md-10">
                                                          ...
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Keperluan</label>
                                                              <div class="col-md-10">
                                                                <input name="keperluan" type="text" value="<?php $row['keperluan'] ?>" class="form-control" rows="5">
                                                              </div>
                                                          </div>

                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Keterangan Lain</label>
                                                              <div class="col-md-10">
                                                                <textarea name="keterangan"type="text" class="form-control" rows="5"></textarea>
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label"> Tgl permohonan</label>
                                                              <div class="col-md-10">
                                                                <input name="tgl_masuk"type="text" class="form-control" >
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Berlaku s/d</label>
                                                              <div class="col-md-10">
                                                                <input name="berlaku"type="text" class="form-control" >
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Pengesah 1</label>
                                                              <div class="col-md-10">
                                                                <input name="pengesah_1"type="text" class="form-control"  value="<?php echo $row['pengesah_1']?>" >
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Pengesah 2</label>
                                                              <div class="col-md-10">
                                                                <input name="pengesah_2"type="text" class="form-control"  value="<?php echo $row['pengesah_2']?>">
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Nama Pengesah 1</label>
                                                              <div class="col-md-10">
                                                                <input name="nmpengesah_1"type="text" class="form-control"  value="<?php echo $row['nmpengesah_1']?>" >
                                                              </div>
                                                          </div>
                                                          <div class="form-group">
                                                              <label style="text-align: left;"class="col-md-2 control-label">Nama Pengesah 2</label>
                                                              <div class="col-md-10">
                                                                <input name="nmpengesah_2"type="text" class="form-control"  value="<?php echo $row['nmpengesah_2']?>">
                                                              </div>
                                                          </div>
                                                          ...
                                                          <button type="submit" style="float:right"type="button" class="btn btn-purple waves-effect waves-light">Update Data</button>
                                                        </form>
                                                        </div>
                                                        </div>
                                                      </div>
